...
class ExtensionsInfo extends Field
{
    ...
    public function render(AbstractElement $element)
    {
        ...
        foreach ($lists as $listKey => $lable) {
            ...
            $html .= '</tr>';
            $html .= '</thead>';
            $html .= '<tbody class="risecommerce-section">';

            foreach ($products as $productKey => $product) {

                $moduleName = 'Risecommerce_' . $productKey;
    ...
    public function getJsonObject()
    {
        ...
        curl_setopt($ch, CURLOPT_URL, 'https://risecommerce.com/media/product-versions-extended.json');
        $result = curl_exec($ch);
        curl_close($ch);
